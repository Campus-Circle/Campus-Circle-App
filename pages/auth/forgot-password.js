        ...
        <div className="flex-grow h-screen flex flex-col font-body justify-center items-center text-center">
                ...
                onSubmit={async (values) => {
                    ...
                    try{
                        ...
                        if(res.data.status == 1)
                            toast.success("Reset Link Sent Successfully, Please Check Your Email (Don't forget to check your spam folder)");
                        // setTimeout(() => {
                        //     router.push('/');
                        // }, 2000);
                    } catch (err){
            ...
            >
                <Form className="flex flex-col justify-center items-center">
                    <Field placeholder="Enter Email Address" name="email" className="my-6 border p-2 rounded-md w-72 focus:outline-primary/50"/>
