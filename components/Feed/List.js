      ...
      <>
        <ul className="flex mt-6">
          <Link href="/feed/hot" className="">
            <li className="flex px-2 rounded-lg  md:px-5 md:py-2 border cursor-pointer mr-4 bg-primary border-primary md:rounded-full">
              <AiFillFire className="text-white self-center" />

              <span className="self-center pl-1 font-semibold text-white">HOT</span>
            </li>
          </Link>

          <Link href="/feed/new">
            <li className="flex px-2 rounded-lg md:px-5  md:py-2 cursor-pointer border  border-primary md:rounded-full ">
              <AiTwotoneWarning className="text-primary self-center" />
              <span className="self-center pl-1 font-semibold text-primary">NEW</span>
            </li>
          </Link>
      ...
      <ul className="flex mt-6">
        <Link href="/feed/hot" className="">
          <li className="flex px-2 rounded-lg md:px-5 mr-4 md:py-2 cursor-pointer border  border-primary md:rounded-full ">
            ...
            <span className="self-center pl-1 font-semibold text-primary">HOT</span>
          </li>
        </Link>
        ...
        <Link href="/feed/new">
          <li className="flex px-2 rounded-lg  md:px-5 md:py-2 border cursor-pointer bg-primary border-primary md:rounded-full">
            ...
            <span className="self-center pl-1 font-semibold text-white">NEW</span>
          </li>
        </Link>
        <li className="flex-grow"></li>
        <Link href="/post/new">
